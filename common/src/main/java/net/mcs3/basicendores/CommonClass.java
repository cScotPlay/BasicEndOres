...
import net.mcs3.basicendores.platform.Services;
...
//        Constants.LOGGER.info("The ID for diamonds is {}", BuiltInRegistries.ITEM.getKey(Items.DIAMOND));
        ...
        if (Services.PLATFORM.isModLoaded("beo")) {

            Constants.LOGGER.info("Hello to Basic End Ores");
        }
        BEOConfiguredFeatures.initialize();
        BEOPlacedFeatures.initialize();
