package com.cscot.basicendores.data.worldgen.placedfeatures;

import com.cscot.basicendores.BasicEndOres;
import com.cscot.basicendores.data.worldgen.ModOrePlacement;
...
public class PlacedFeatureGenerator
{
    ...
    public static void onGatherData(GatherDataEvent event)
    {
        ...
        final Holder<ConfiguredFeature<?,?>> configuredGoldFeatureHolder = ops.registry(Registry.CONFIGURED_FEATURE_REGISTRY).get().getOrCreateHolderOrThrow(ResourceKey.create(Registry.CONFIGURED_FEATURE_REGISTRY, GOLD_ORE_KEY.location()));
        ...
        final PlacedFeature goldOreFeature = new PlacedFeature(configuredSilverFeatureHolder, ModOrePlacement.ORE_GOLD_PLACED_FEATURE);
