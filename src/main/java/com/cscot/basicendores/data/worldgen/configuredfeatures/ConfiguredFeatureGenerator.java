package com.cscot.basicendores.data.worldgen.configuredfeatures;
...
public class ConfiguredFeatureGenerator
{
    ...
    public static void onGatherData(GatherDataEvent event)
    {
        ...
        final ConfiguredFeature goldOreConfig = new ConfiguredFeature(Feature.ORE, ModOreConfiguredFeatures.ORE_GOLD_CONFIGURED_FEATURE);
