...
import com.cscot.basicendores.blocks.ModBlocks;
import com.cscot.basicendores.blocks.ModMetalBlocks;
import com.cscot.basicendores.blocks.ModRawOreBlocks;
...
public class BlockLists
{
    ...
    private static <block extends Block> block add(String name, block block) {
        BLOCKS.put(new Identifier(BasicEndOres.MOD_ID, name), block);
        return block;
    }
}
