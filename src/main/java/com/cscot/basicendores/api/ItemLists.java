...
public class ItemLists
{
    ...
    public static Item ZINC_INGOT = addItem("zinc_ingot", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    ...
    public static Item ZINC_NUGGET = addItem("zinc_nugget", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));

    //Raw Ore List
    public static Item RAW_ALUMINUM = addItem("raw_aluminum", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    public static Item RAW_LEAD = addItem("raw_lead", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    public static Item RAW_NICKEL = addItem("raw_nickel", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    public static Item RAW_SILVER = addItem("raw_silver", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    public static Item RAW_TIN = addItem("raw_tin", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    public static Item RAW_OSMIUM = addItem("raw_osmium", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    public static Item RAW_URANIUM = addItem("raw_uranium", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
    public static Item RAW_ZINC = addItem("raw_zinc", new Item((new Item.Settings()).group(BasicEndOres.ITEMGROUP)));
