...
public class ModOreConfiguredFeatures
{
    ...
    {
        RegistryKey<ConfiguredFeature<?, ?>> oreEmeraldEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_emerald_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreEmeraldEnd.getValue(), ORE_EMERALD_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreDiamondEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_diamond_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreDiamondEnd.getValue(), ORE_DIAMOND_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreRedstoneEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_redstone_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreRedstoneEnd.getValue(), ORE_REDSTONE_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreLapisEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_lapis_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreLapisEnd.getValue(), ORE_LAPIS_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreCoalEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_coal_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreCoalEnd.getValue(), ORE_COAL_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreSilverEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_silver_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreSilverEnd.getValue(), ORE_SILVER_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreIronEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_iron_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreIronEnd.getValue(), ORE_IRON_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreLeadEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_lead_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreLeadEnd.getValue(), ORE_LEAD_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreNickelEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_nickel_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreNickelEnd.getValue(), ORE_NICKEL_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreCopperEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_copper_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreCopperEnd.getValue(), ORE_COPPER_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreAluminumEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_aluminum_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreAluminumEnd.getValue(), ORE_ALUMINUM_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreTinEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_tin_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreTinEnd.getValue(), ORE_TIN_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreOsmiumEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_osmium_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreOsmiumEnd.getValue(), ORE_OSMIUM_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreUraniumEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_uranium_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreUraniumEnd.getValue(), ORE_URANIUM_END);

        RegistryKey<ConfiguredFeature<?, ?>> oreZincEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(modID, "ore_zinc_end"));
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, oreZincEnd.getValue(), ORE_ZINC_END);
    }
//    public static String modID = BasicEndOres.MOD_ID;
//
//    public static ConfiguredFeature<?, ?> ORE_EMERALD_END = Feature.ORE
