...
{
    public static final RegistryEntry<PlacedFeature> ORE_EMERALD_PLACED_FEATURE = PlacedFeatures.register(OreFeatureLists.EMERALD_ORE_FEATURE_ID,
            ModOreConfiguredFeatures.ORE_EMERALD_CONFIGURED_FEATURE, modifiersWithCount(ModConfig.emeraldPerChunk,
    ...
    public static final RegistryEntry<PlacedFeature> ORE_GOLD_PLACED_FEATURE = PlacedFeatures.register(OreFeatureLists.GOLD_ORE_FEATURE_ID,
            ModOreConfiguredFeatures.ORE_GOLD_CONFIGURED_FEATURE, modifiersWithCount(ModConfig.goldPerChunk,
                    HeightRangePlacementModifier.uniform(YOffset.fixed(ModConfig.goldMinHeight),YOffset.fixed(ModConfig.goldMaxHeight))));
    ...
    public static void initOrePlacedFeatures()
    {
        if(ModConfig.emeraldGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES,  RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.EMERALD_ORE_FEATURE_ID)));
        }

        if(ModConfig.diamondGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.DIAMOND_ORE_FEATURE_ID)));
        }

        if(ModConfig.redstoneGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.REDSTONE_ORE_FEATURE_ID)));
        }

        if(ModConfig.lapisGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.LAPIS_ORE_FEATURE_ID)));
        }

        if(ModConfig.coalGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.COAL_ORE_FEATURE_ID)));
        }

        if(ModConfig.silverGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.SILVER_ORE_FEATURE_ID)));
        }

        if(ModConfig.goldGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.GOLD_ORE_FEATURE_ID)));
        }

        if(ModConfig.ironGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES,  RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.IRON_ORE_FEATURE_ID)));
        }

        if(ModConfig.leadGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.LEAD_ORE_FEATURE_ID)));
        }

        if(ModConfig.nickelGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.NICKEL_ORE_FEATURE_ID)));
        }

        if(ModConfig.copperGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.COPPER_ORE_FEATURE_ID)));
        }

        if(ModConfig.aluminumGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.ALUMINUM_ORE_FEATURE_ID)));
        }

        if(ModConfig.tinGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.TIN_ORE_FEATURE_ID)));
        }

        if(ModConfig.osmiumGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.OSMIUM_ORE_FEATURE_ID)));
        }

        if(ModConfig.uraniumGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.URANIUM_ORE_FEATURE_ID)));
        }

        if(ModConfig.zincGeneration) {
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(OreFeatureLists.ZINC_ORE_FEATURE_ID)));
        }
    }
